    ...
    <div className="hero__hanger-wrap">
      ...
      >
        <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Hook */}
          <path d="M100 20 C100 20 112 20 112 32 C112 44 100 44 100 44" stroke="#d4af37" strokeWidth="3" strokeLinecap="round" fill="none" filter="url(#glow)" />
          <circle cx="100" cy="16" r="5" fill="#d4af37" filter="url(#glow)" />

          {/* Hanger bar */}
          <path d="M100 44 L100 68 L42 110 Q30 120 30 130 L170 130 Q170 120 158 110 L100 68" stroke="#d4af37" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="rgba(212,175,55,0.06)" filter="url(#glow)" />
          ...
          <motion.g animate={{ opacity: [0, 1, 0] }} transition={{ duration: 2, repeat: Infinity, delay: 0.5 }}>
            <line x1="35" y1="60" x2="35" y2="70" stroke="#d4af37" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
            <line x1="30" y1="65" x2="40" y2="65" stroke="#d4af37" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
          </motion.g>
          <motion.g animate={{ opacity: [0, 1, 0] }} transition={{ duration: 2, repeat: Infinity, delay: 1.2 }}>
            <line x1="160" y1="75" x2="160" y2="83" stroke="#d4af37" strokeWidth="1.5" strokeLinecap="round" opacity="0.6" />
            <line x1="156" y1="79" x2="164" y2="79" stroke="#d4af37" strokeWidth="1.5" strokeLinecap="round" opacity="0.6" />
          </motion.g>
          <motion.g animate={{ opacity: [0, 1, 0] }} transition={{ duration: 2.5, repeat: Infinity, delay: 0.2 }}>
            <circle cx="145" cy="55" r="2" fill="#d4af37" opacity="0.7" />
          </motion.g>

          {/* Fabric */}
          <path d="M35 130 Q40 155 55 162 L145 162 Q160 155 165 130 Z" fill="rgba(212,175,55,0.08)" stroke="rgba(212,175,55,0.25)" strokeWidth="1" />
          <line x1="80" y1="130" x2="80" y2="162" stroke="rgba(212,175,55,0.15)" strokeWidth="1" />
          <line x1="120" y1="130" x2="120" y2="162" stroke="rgba(212,175,55,0.15)" strokeWidth="1" />
        </svg>
      </motion.div>
